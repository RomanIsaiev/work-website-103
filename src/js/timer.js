...
// const deadline = new Date(2025, 2, 26, 10, 0, 0).getTime();
...
//     const now = new Date();
//     return now.getTime() + 1 * 24 * 60 * 60 * 1000; // Добавляем 3 дня к текущему времени
//   }
